...
LIB=$1
RUNDIR=$2
IP4_HOST=$3 # initArgIPv4NodeIP
IP6_HOST=$4 # initArgIPv6NodeIP
MODE=$5
TUNNEL_MODE=$6
# Only set if MODE = "direct", "ipvlan"
NATIVE_DEVS=$7 # initArgDevices
HOST_DEV1=$8 
HOST_DEV2=$9
MTU=${10}
HOSTLB=${11}      # initArgHostReachableServices
HOSTLB_UDP=${12}  # initArgHostReachableServicesUDP
HOSTLB_PEER=${13} # initArgHostReachableServicesPeer
CGROUP_ROOT=${14}
BPFFS_ROOT=${15}
NODE_PORT=${16}
NODE_PORT_BIND=${17}
