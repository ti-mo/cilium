...
var apiRateLimitDefaults = map[string]rate.APILimiterParameters{
	...
	// latency of delete calls, on fast systems, an even higher number of
	// parallel requests will be allowed.  Logging is enabled for
	// visibility as frequency should be low.
	...
	// limited. On a fast system, the limit should become more liberal
	// automatically.
